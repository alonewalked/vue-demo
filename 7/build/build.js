...
/***/ function(module, exports, __webpack_require__) {
	...
	window.lscache = __webpack_require__(3);
	// define some components
	window.Vue = __webpack_require__(4);
	window.VueRouter = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.use(__webpack_require__(108));
	__webpack_require__(110);
	__webpack_require__(111);
	__webpack_require__(112);
	Vue.use(__webpack_require__(114)); 
	var cIndx = 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".goTop{width:50px;height:48px;position:fixed;right:6px;bottom:55px;z-index:2001; display:block;color:#fff;width:40px;height:40px;text-align:center;margin-top:5px;border-radius:5px;background-color:rgba(0,0,0,0.7);font-size:10px;color:#fff;font-size:1.25rem;padding-top:5px;cursor: pointer;}\r\n.dot{display:inline-block;width:15px;height:15px;background-color:#f45910;border-radius:4px;vertical-align:top;margin:3px -6px 0 0;line-height:15px;font-size:10px;font-style:normal;color:#fff;text-align: center;border-radius:50%;}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.install = function (Vue, options) {
		Vue.directive('detect-viewport', __webpack_require__(109))
	}
...
/***/ function(module, exports) {
	...
	module.exports = "<footer class=\"loading\" v-detect-viewport >\r\n\t<p>{{reddit.finished?\"没有更多了\":\"加载中...\"}}</p>\r\n</footer>";
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"list-group table-of-contents\" >\r\n    <div class=\"list-group-item\" v-repeat=\"item in images\">\r\n    <lazy-img data-src=\"{{item.url}}\"></lazy-img>\r\n    <a href=\"#\"><red-dot key=\"list_{{$index}}\" newer=\"{{todaykey}}\" number=\"{{$index}}\"></red-dot></a>\r\n    </div>\r\n</div>\r\n<load-more reddit=\"{{reddit}}\"></load-more>\r\n<div v-top-box href=\"#\" class=\"goTop\">top</div>";
