...
/***/ function(module, exports) {
	...
	module.exports = "<section>\r\n<my-slider v-bind:items=\"imgs\"></my-slider>\r\n</section>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swipe = __webpack_require__(21);
	...
	var MySlider = _vue2.default.extend({
	    ...
	    methods: {
	        ...
	        setup: function setup() {
	            this.swipe = (0, _swipe2.default)(this.wrapper, {
	                pagerCon: $(this.pager),
	                active: 'selected',
	                auto: 5000
	            });
	...
	// register
	_vue2.default.component('my-slider', MySlider);
...
/***/ function(module, exports) {
	...
	(function () {
	  function Swipe(container, options) {
	    ...
	    options.bulletClass = options.bulletClass || '';
	    function _setup(init) {
	      ...
	      // init pager
	      if (options.pagerCon) {
	        options.active = options.active || 'on';
	        initPager(options.pagerCon);
	        selectPage();
	      }
	    ...
	    function initPager(elem) {
	      var _html = '',
	          i;
	      for (i = 0; i < slides.length; i++) {
	        (function (i) {
	          _html += '<span class="' + options.bulletClass + '"></span>';
	        })(i);
	      }
	      elem.html(_html);
	    }
	    ...
	    function selectPage() {
	      if (options.pagerCon) {
	        options.pagerCon.find('span').eq(index).addClass(options.active).siblings().removeClass(options.active);
	      }
	    }
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"scroll-all swiper-container\" v-el:wrapper>\r\n    <ul class=\"scroll\" v-el:list> \r\n    <li class=\"scroll-list\" v-for=\"item in items\">\r\n        <a class=\"scroll-link\" >\r\n        <img v-bind:src.once=\"item.img\" width=\"100%\">\r\n        </a>\r\n        <a class=\"down-link\"> 下载 </a>\r\n    </li>\r\n    </ul>\r\n</div> \r\n<div class=\"scroll-focus\" v-el:pager></div>";
