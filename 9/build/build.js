...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myiscroll = __webpack_require__(20);

	var _myiscroll2 = _interopRequireDefault(_myiscroll);
	...
	exports.default = {
	    ...
	    components: {
	        'my-iscroll': _myiscroll2.default
	    },
	    data: function data() {
	        return {
...
/***/ function(module, exports) {
	...
	module.exports = "<section>\r\n<my-iscroll v-bind:items=\"imgs\"></my-iscroll>\r\n</section>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyIscroll = _vue2.default.extend({
	    ...
	    methods: {
	        ...
	        setup: function setup() {
	            ...
	            this.scroll = new _iscroll2.default(this.wrapper, {
	                scrollY: false,
	                scrollX: true,
	...
	// register
	_vue2.default.component('my-iscroll', MyIscroll);

	exports.default = MyIscroll;
	...
	(function (window, document, Math) {
	    ...
	    IScroll.prototype = {
	        ...
	        _move: function _move(e) {
	            ...
	            if (this.y < this.maxScrollY - 5 || this.y > this.maxScrollY + 5) {
	        ...
	        _end: function _end(e) {
	            ...
	            if (this.resetPosition(this.options.bounceTime)) {
	                this._execEvent('scrollOutBoundaries');
	                return;
	            }
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"detail-pic\" v-el:wrapper>\r\n<ul class=\"detail-lide slide_pic\" v-el:list>\r\n<li v-for=\"item in items\">\r\n<img v-bind:src.once=\"item.img\" >\r\n</li>\r\n</li>\r\n\r\n</ul>\r\n</div>\r\n";
