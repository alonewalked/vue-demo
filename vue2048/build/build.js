...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.component('v-main', {
	    template: _game2.default,
	    components: {
	        "v-tile": _tile2.default
	    },
	    directives: {
	        selected: {
	            isEmpty: true,
	            bind: function bind() {
	                if (this.vm.conf.size) this.el.value = this.vm.conf.size;
	            }
	        }
	    },
	    data: function data() {
	        return {
	            ...
	            tiles: [],
	            grid: [],
	            conf: _store2.default.fetch('vue2048-config')
	        };
	    },
	    created: function created() {
	        var opt = (0, _utils.getWindowSize)();
	        this.$set('tileDimension', opt.dimension);
	        this.$set('tilePosition', opt.position);
	    },
	    ready: function ready() {
	        var data = _store2.default.fetch('vue2048'),
	            conf = this.conf;
	        // go on latest
	        if (conf.score) {
	    ...
	    attached: function attached() {
	        ...
	        Keys = new _keys2.default();
	        Keys.on('move', function (direction) {
	            _this.move(direction);
	        });
	        window.onresize = function (event) {
	            var opt = (0, _utils.getWindowSize)();
	            _this.$set('tileDimension', opt.dimension);
	            _this.$set('tilePosition', opt.position);
	        };
	    },

	    //Can go to templates
	    computed: {
	        findDimension: function findDimension() {
	    ...
	    methods: {
	        ...
	        // init grid matrix
	        initArrayGrid: function initArrayGrid(size) {
	            var arr = [];
	        ...
	        changesTilesSize: function changesTilesSize(e) {
	            e.preventDefault();
	        ...
	        findFarthestPosition: function findFarthestPosition(cell, vector) {
	            var previous;
	            do {
	                previous = cell;
	                cell = {
	        ...
	        findTile: function findTile(position) {

	            if (position.x === -1 || position.y === -1) return null;else {
	                var tiles = this.tiles;
	        ...
	        // move tile
	        moveTile: function moveTile(tile, position) {
	        ...
	        mergeTiles: function mergeTiles(curr, next, position) {
	        ...
	        // inner edge
	        withinBounds: function withinBounds(position) {
	            var size = this.conf.size;
	        ...
	        updateScore: function updateScore(score) {
	            ...
	            if (score === 2048) this.message(true);
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    save: function save(STORAGE_KEY, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// tile
	exports.default = _vue2.default.component('v-tile', {
...
/***/ function(module, exports) {
	...
	module.exports = "<div  v-bind:style=\"{transform: 'translate(' + calcStyleX + 'px,' + calcStyleY + 'px)'}\" class=\"tile tile-{{tile.value}} tile-new{{tile.merged ? ' tile-merged' : ''}}\">\r\n    <div class=\"tile-inner\">{{tile.value}}</div>\r\n</div> ";
